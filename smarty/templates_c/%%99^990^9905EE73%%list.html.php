<?php /* Smarty version 2.6.19, created on 2009-11-01 01:49:31
         compiled from list.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'list.html', 46, false),)), $this); ?>
...
?> 
		<tr>
			...
			<td> 
			<form method="post" action="<?php echo $this->_tpl_vars['base']; ?>
/admin/editMunicipality.php?input=<?php echo $this->_tpl_vars['mun']['id']; ?>
">
...
<form method="post" action="<?php echo $this->_tpl_vars['base']; ?>
/admin/editMunicipality.php?input=new">
...
/admin/index.php?input=' + this.value;">
...
?> 
		<tr>
			...
			<td> 
			<form method="post" action="<?php echo $this->_tpl_vars['base']; ?>
/admin/editLocation.php?input=<?php echo $this->_tpl_vars['point']['id']; ?>
">
			<input type="submit" value="edit"/>
			</form>
			</td>
