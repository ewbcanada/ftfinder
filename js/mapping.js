 ...
 *                                                                        *
 * mapping.js:                                                            *
 * Javascript to provide search and display functionality.                *
 *                                                                        *
 * NOTE: this file is currently a bit of a mess, and needs clean-up       *
 *  and documentation. (and jQuery-izing it wouldn't hurt...)             *
 *                                                                        *
 **************************************************************************/
...
// Loading icon courtesy of http://www.ajaxload.info/ - they're awesome!
var loadingIcon = "icons/ajax-loader.gif";

var tinyIcon = new GIcon();
tinyIcon.image = "icons/red-dot.png";
...
locationIcon.image="icons/POI.png";
...
{
	var iconPath = "icons/" + colour + "_Marker";
...
function xmlQuery(){
	return "search.php?locCat="+locCatVar+"&locSearch="+locSearchVar
